    ...
    <div className="home-continer">
      ...
      <div className="home-description">
        ...
        <p id="desc1">
          ...
          and viewers can benefit from each other. Are you a YouTuber looking to
          boost your video views? Or maybe you enjoy watching videos and would
          like to earn rewards while doing so? Look no further - you have come
          to the right place!
        </p>
